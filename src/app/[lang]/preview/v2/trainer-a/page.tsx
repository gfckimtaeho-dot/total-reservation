...
// 트레이너 첫 화면 = 캘린더 중심. 실제 DashboardTrainer 의 헤더+TrainerCalendarPro
// 구조를 Airbnb 정통 톤 (white + #FF385C accent) 으로 모사.
...
export default function TrainerAPreview() {
  return (
    <main className="min-h-screen bg-white text-[#222222] font-sans">
      <PreviewHeader role="트레이너" variant="A" back="../" />

      <header className="border-b border-[#DDDDDD]">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-6 py-4">
          <div>
            ...
            >
              <span className="text-[#717171]">스트롱헬스 강남점</span>
              <span className="mx-2 text-[#DDDDDD]">/</span>
              <span style={{ fontWeight: 800 }}>Han 트레이너</span>
            </h1>
          </div>
          <nav className="flex flex-wrap items-center gap-2">
            <button className="rounded-full border border-[#222222] bg-white px-4 py-2 text-xs font-semibold hover:bg-[#222222] hover:text-white">
              QR
            </button>
            <button className="rounded-full border border-[#DDDDDD] bg-white px-4 py-2 text-xs font-semibold hover:border-[#222222]">
              Showcase
            </button>
      ...
      <section className="mx-auto max-w-6xl px-6 py-6">
        ...
        <div className="overflow-x-auto rounded-xl border border-[#DDDDDD]">
