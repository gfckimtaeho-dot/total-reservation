...
const accent = {
  ...
  divide: "divide-cyan-400/15",
  ring: "ring-cyan-400/30",
  text: "text-cyan-300",
  pill: "bg-cyan-400/15 text-cyan-300 ring-cyan-400/40",
  badge: "bg-cyan-400 text-zinc-950",
  todayBg: "bg-cyan-400/10",
  todayRing: "ring-cyan-400",
  cellBorder: "border-cyan-400/15",
};
