...
- 폐지(2026-09-24): 환불 요청 화면(/refunds). 환불은 회원 상세 보유 상품(권별 환불/전체 환불, 소진 권 opacity-40 + 소진 칩, 매장귀책 대기 amber 박스)과 /members/[id]/refund 폼(환불완료 버튼=emerald, 정가 안내 rose)에서 처리.
