...
const accent = {
  ...
  divide: "divide-lime-300/15",
  ring: "ring-lime-300/30",
  text: "text-lime-300",
  pill: "bg-lime-300/15 text-lime-300 ring-lime-300/40",
  badge: "bg-lime-300 text-zinc-950",
  todayBg: "bg-lime-300/10",
  todayRing: "ring-lime-300",
  cellBorder: "border-lime-300/15",
};
